...
// the successor model misses indirect-continuation edges. Store-side narrowing
// stays; the reload restores everything the function uses again.
#define DOLLLVM_CACHE_VERSION "dolllvm-v10"
